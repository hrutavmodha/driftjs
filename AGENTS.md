...
│   │   └── tsconfig.json
│   │
│   ├── router/             # @driftjs/router — native client-side router (see docs/ROUTER.md)
│   │   ├── index.ts        # Package entry: re-exports Router/History/Matcher/Route/Link/types
│   │   ├── Router.ts        # DriftRouter class + createRouter() — guards, redirects, mount/unmount
│   │   ├── History.ts       # DriftHistory — pushState/replaceState/back/forward/popstate
│   │   ├── Matcher.ts        # normalizeRoutes(), matchRoute() — segment-based path matching
│   │   ├── Route.ts          # resolveComponent() (incl. lazy import), buildLocation()
│   │   ├── Link.ts           # installLinkInterception() — <a data-drift-link> click handling
│   │   ├── types.ts          # RouteDefinition, RouteRecord, RouteLocation, guards, options
│   │   ├── tests/
│   │   │   ├── matcher.test.ts
│   │   │   ├── router.test.ts
│   │   │   └── link.test.ts
